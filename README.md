...
- Trial cache hit списывает 1 бесплатное распознавание, потому что пользователь получил результат.
...
8. Нажмите `Оплатить Designer картой` или `Оплатить Studio картой`: бот должен отправить URL-кнопку Робокассы.
9. Пользователь должен видеть кнопку `Оплатить картой`.

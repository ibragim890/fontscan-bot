...
NO_ACTIVE_SUBSCRIPTION_TEXT = "У вас нет активного доступа."
...
LAUNCH_OFFER_TEXT = """<b>Вы использовали бесплатное распознавание 🐙</b>

Для первых пользователей открыт спец-доступ:

<b>50 распознаваний за 99 ₽</b>
<s>199 ₽</s>

Скидка действует <b>24 часа</b>.

После окончания цена станет <b>199 ₽</b>."""

LAUNCH_OFFER_REMINDER_TEXT = """<b>🐙 Скидка ещё активна</b>

<b>50 распознаваний за 99 ₽</b>
<s>199 ₽</s>

Осталось: <b>{hours_left} ч.</b>

После окончания цена станет <b>199 ₽</b>."""

OFFER_EXPIRED_TEXT = """<b>Скидка уже закончилась.</b>

Можно купить пакет:
<b>50 распознаваний за 199 ₽</b>"""

PAYMENT_SUCCESS_TEXT = """<b>Оплата прошла ✅</b>

Начислено: <b>{recognitions_count} распознаваний</b>
...
3. После пробного доступа нужен платный пакет.
